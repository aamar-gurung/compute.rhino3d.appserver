...
async function compute(){
  ...
  const data = {
    ...
    inputs: {
      'ring': ring_slider.valueAsNumber,
      'offset1': offset1_slider.valueAsNumber,
      'offset2': offset2_slider.valueAsNumber
    }
  }
